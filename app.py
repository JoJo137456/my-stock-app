...
<b>【指標註解】</b>：美元指數上漲代表美元強勢（非美貨幣相對弱勢）；就台灣整體而言，強勢美元使台幣相對貶值，雖有利於出口報價競爭力及外銷企業毛利，但會增加原物料進口成本與輸入性通膨壓力。",
    "💱 美元兌台幣": "反映美元與新台幣之雙邊匯率。受台灣經常帳餘額、外資進出台股之資本帳流動及美台利差影響。直接決定台灣出口導向企業之報價競爭力與匯兌損益認列。

<b>【指標註解】</b>：數值上漲代表美元升值、台幣貶值；對台灣經濟而言，台幣貶值有利於外銷產業擴張出口毛利（如電子零組件、化纖紡織），但不利於內需進口產業及美元計價負債較高之企業。"
}
INDUSTRY_PEERS = {
