...
MACRO_IMPACT = {
    ...
    "🇺🇸 Nasdaq": {
        ...
        "strategy": "此板塊對利率極度敏感。當其大幅回撤時，預示市場資金成本可能生變，集團應暫緩高風險的新創型資本支出。"
    },
    "🇺🇸 SOX (費半)": {
        ...
        "strategy": "做為台灣景氣的最前線斥候。當費半出現連續破底，遠東銀的消金與企金部門應提早進行壓力測試，緊縮風險放款。"
    },
    "⚠️ VIX 恐慌指數": {
    ...
    "🔥 天然氣 (Natural Gas)": {
        ...
        "strategy": "冬季與戰爭期間波動最劇烈。集團高耗能廠區應隨時監控天然氣基差，並考慮綠電轉型以降低化石燃料的受制風險。"
    },
    "💾 記憶體產業 (美光)": {
    ...
    "💵 美元指數": {
        "exp": "衡量美元兌一籃子主要貨幣的相對強弱。強勢美元通常導致新興市場資金外流及大宗商品價格承壓。",
        "up": "新興市場貨幣貶值；集團進口原料(煤炭、原油衍生品)採購成本將飆升；遠東銀需防範新興市場債務違約風險。",
