...
def check_password():
    ...
    <style>
        ...
        div[data-baseweb="input"]:focus-within > div { 
            border: 1.5px solid #1A1B20 !important;
            box-shadow: 0 0 0 3px rgba(26,27,32,0.1) !important;
        }
...
<div style="background-color: #1c1c1e; padding: 30px; border-radius: 20px; margin-bottom: 25px; border: 1px solid #38383a;">
    ...
    <div style="display: flex; align-items: baseline; gap: 20px; margin-top: 8px;">
        ...
        <span style="font-size: 1.8rem; font-weight: 600; color: {font_color}; font-family: 'Inter', sans-serif;">
             {change:+.2f} ({pct:+.2f}%)
        </span>
    </div>
</div>
